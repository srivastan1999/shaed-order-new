-- ============================================================================
-- Ford Field Changes Query - BigQuery
...
-- 
-- USAGE:
-- 1. Set DATE1 and DATE2 in your .env file (lines 15-16, MM.DD.YYYY format)
--    Example: DATE1=MM.DD.YYYY
--             DATE2=MM.DD.YYYY
-- 2. Run: python generate_ford_field_changes_sql.py
-- 3. This creates ford_field_changes_query_generated.sql with dates from .env
-- 4. Copy query from the generated file into BigQuery
--
-- The dates (2025-11-07 (old) and 2025-11-10 (new)) are automatically read from .env file (DATE1 and DATE2)
-- Lower date = old_data, Higher date = new_data
-- ============================================================================
