...
from .processors import OrdersProcessor, OEM_PROCESSORS
from .downloader import OEMDownloader
...
def main():
    ...
    try:
        if args.command == "orders":
            processor = OrdersProcessor(output_dir=args.output_dir)
            processor.export_to_csv(upload_to_gcs_flag=not args.no_upload)
            ...
            orders_processor.export_to_csv(upload_to_gcs_flag=not args.no_upload)
